...
void TrainingVisualizer::noVisualization(unsigned long gen, double bestFitness, double avgFitness) {
  wrefresh(window);
  mvwprintw(window, 2, 2, "Generation: %d", gen);
  mvwprintw(window, 3, 2, "Best Fitness: %lf", bestFitness);
  mvwprintw(window, 4, 2, "Average Fitness: %lf", avgFitness);
}
